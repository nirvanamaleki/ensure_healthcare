              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              's9ijazmg' /* Fill out the information below... */,
                            ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'l4nxc4ts' /* Emails will be sent to: */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyText1,
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown(
                      options: [
                        FFLocalizations.of(context).getText(
                          'nuj9xng8' /* Type of Appointment */,
                        ),
                        FFLocalizations.of(context).getText(
                          'hln42jow' /* Doctors Visit */,
                        ),
                        FFLocalizations.of(context).getText(
                          'cgypzm0b' /* Routine Checkup */,
                        ),
                        FFLocalizations.of(context).getText(
                          'o08s4k0f' /* Scan/Update */,
                        )
                      ].toList(),
